...
{{-- {{asset('assets/front/    ')}} --}}
       ...
       <!-- ========== Package Banner ========== -->
       <div class="tourmaster-single-header" style="background-image: url('{{asset('images/main/'. $region->banner_image)}}');">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="COL-12 trip-topic triphead-block p-0">
                                ...
                                <h1 class="tourmaster-single-header-title">{{ $region->name }}</p>
                                </h1>
    ...
    <!-- ========== package-listing ========== -->
    <section class="package-listing catego">
        <div class="container">
