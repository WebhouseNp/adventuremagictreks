...
<title>Adventure Magic | {{$destinationType->title}}</title>
@section('content')
{{-- {{asset('assets/front/    ')}} --}}

       <!-- ========== Package Banner ========== -->
       <div class="tourmaster-single-header" style="background-image: url('{{asset('images/main/'. $destinationType->banner_image)}}');">
        ...
        <div class="tourmaster-single-header-container tourmaster-container">
            <div class="tourmaster-single-header-container-inner">
                <div class="tourmaster-single-header-title-wrap tourmaster-item-pdlr">
                    <div class="container">
                        <div class="row">
                            <div class="COL-12 trip-topic triphead-block p-0 newfo">
                                <div class="tourmaster-single-header-gallery-wrap"></div>

                                <h1 class="tourmaster-single-header-title">{{ $destinationType->title }}</p>
                                </h1>
    ...
    <!-- ========== package-listing ========== -->
    <section class="package-listing t">
        <div class="container">
            ...
            <div class="package-listing-popular">
                <div class="package-listing-title">
                    <h1>{{ $destinationType->title }} Packages</h1>
                </div>

                <div class="row mt-5">
                    @foreach ($destinationCategoryPackages as $package)
                ...
                {{$destinationCategoryPackages->links()}}
