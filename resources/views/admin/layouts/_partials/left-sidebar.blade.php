        ...
        <ul class="side-menu metismenu">
            ...
            <li>
                <a href="javascript:;">
                    ...
                    <span class="nav-label">Travel Style</span>
                    <i class="fa fa-angle-left arrow"></i>
                </a>
                <ul class="nav-2-level collapse">
                    <li>
                        <a href="{{route('travelstyle.create')}}">
                            <span class="fa fa-plus"></span>
                            Add Travel Style
                        </a>
                    </li>
                    <li>
                        <a href="{{route('travelstyle.index')}}">
                            <span class="fa fa-circle-o"></span>
                            All Travel Styles
                        </a>
                    </li>
            ...
            <li>
                <a href="javascript:;">
                    ...
                    <span class="nav-label">Customized Booking</span>
                    <i class="fa fa-angle-left arrow"></i>
                </a>
            ...
            {{-- <li>
                <a href="{{route('destinationtype.index')}}"><i class="sidebar-item-icon fa fa-wrench"></i>
                  <span class="nav-label">Destination Type</span></a>
            </li> --}}
