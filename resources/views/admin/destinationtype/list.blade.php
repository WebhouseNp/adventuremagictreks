...
<div class="page-heading">
    <h1 class="page-title">Destination Type</h1>
                ...
                <tbody class="row_drag">
                  ...
                  @if($details->count())
                    ...
                    <tr data-id="{{$data->id}}">
                      ...
                      <td><a href="/images/main/{{$data->banner_image}}" target="_blank"><img style="height:90px; width: 90px;" src="{{$data->banner_image ? asset('/images/main/' . $data->banner_image) : '/assets/admin/images/image.jpg' }}"></a></td>
