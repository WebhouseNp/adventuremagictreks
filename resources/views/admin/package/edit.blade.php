                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="travelstyle_id[]" class="travel-style form-control" multiple>
                                    <option value="">-- select one --</option>
                                    @foreach($travelStyles->toArray() as $travelStyle)
                                    <option value="{{$travelStyle['id']}}" {{($detail->travelstyles->where('slug',$travelStyle['slug'])->count()==0)?'':'selected'}}>{{$travelStyle['title']}}</option>
                                    @endforeach
                                </select>
                            </div>
...
<div class="form-group col-md-6">
    ...
    <div id="wrapper1" class="mt-2">
        <div id="image-holder1">
            @if($detail->map_image)
            <img src="{{asset('/images/listing/'. $detail->map_image)}}" style="margin-top:12px; margin-bottom:12px;" height="120px" width="120px" alt="">
            @endif
        </div>
    </div>
</div>
...
<div class="check-list col-md-2">
 ...
 <div class="check-list col-md-2">
    <label class="ui-checkbox ui-checkbox-primary">
        <input name="special_package" type="checkbox" {{$detail->special_package ? 'checked' : ''}}>
        <span class="input-span"></span>Special Package</label>
</div> 
<div class="check-list col-md-2">
    <label class="ui-checkbox ui-checkbox-primary">
        <input name="recommanded_package" type="checkbox" {{$detail->recommanded_package ? 'checked' : ''}}>
