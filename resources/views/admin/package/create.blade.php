                ...
                <div class="ibox">
                    ...
                    <div class="ibox-body" style="">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label>Select Travel Style</label>
                                <select name="travelstyle_id[]" class="travel-style form-control" multiple>
                                    <option value="">-- select one --</option>
                                    @foreach($travelStyles as $travelStyle)
                                        <option value="{{$travelStyle->id}}">{{$travelStyle->title}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            {{-- <div class="form-group col-md-6">
                                ...
                                <input class="form-control" type="text" value="{{old('nature_of_trek')}}" name="nature_of_trek" placeholder="Example: Cultural, Adventure">
                            </div> --}}
                        ...
                        <div class="row">
                           ...
                           {{-- <div class="check-list col-md-2">
                            ...
                            <div class="check-list col-md-2">
                                <label class="ui-checkbox ui-checkbox-primary">
                                    <input name="upcoming_trips" type="checkbox">
                            ...
                            {{-- <div class="check-list col-md-2">
                                <label class="ui-checkbox ui-checkbox-primary">
                                    <input name="mountain_trek" type="checkbox">
                                    <span class="input-span"></span>Mountain Trekking</label>
                            </div>
                            <div class="check-list col-md-2">
                                <label class="ui-checkbox ui-checkbox-primary">
                                    <input name="peak_climbing_expeditions" type="checkbox">
                                    <span class="input-span"></span>Peak Climbing & Expeditions</label>
                            </div>
                            <div class="check-list col-md-2">
                                <label class="ui-checkbox ui-checkbox-primary">
                                    <input name="adventure_road_trip" type="checkbox">
                                    <span class="input-span"></span>Adventure Road Trip</label>
                            </div> --}}

                             <div class="check-list col-md-2">
                                <label class="ui-checkbox ui-checkbox-primary">
                                    <input name="special_package" type="checkbox">
                                    <span class="input-span"></span>Special Packages</label>
                            </div> 
                            <div class="check-list col-md-2">
                                <label class="ui-checkbox ui-checkbox-primary">
                                    <input name="recommanded_package" type="checkbox">
                                    <span class="input-span"></span>Recommended Package</label>
                            </div>
